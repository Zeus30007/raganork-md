...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/55f72d687f1bdb240f51d.jpg I humbly declare that I am alive, sir/madam {sender}, 🦊\n Uptime: {uptime}",
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '6797309646',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝙅 𝙄 𝙉 𝙓 - 𝙈 𝘿;ꂵꀤꋪꍏꀤ🦊ꎇꂦꊼ ;0;https://telegra.ph/file/3c95155e7ea2936d2daac.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHbps://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "J I N X - M D - #v2﻿ ﻿ 🔗",
    BOT_NAME: process.env.BOT_NAME || 'J I N X - M D',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "punlic" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;Raganork MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
