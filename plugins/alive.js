...
┃${star}│🐥╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═╝🐥 
┃${star}│🐥𝔹𝕪 𝕄𝕚𝕣𝕒𝕚 𝕗𝕠𝕩🐥 
┃${star}│ _🐥🄾🅆🄽🄴🅁🐥_ : ${BOT_INFO.split(";")[1]}
┃${star}│ _🐥🅄🅂🄴🅁🐥_ : ${message.senderName.replace( /[\r\n]+/gm, "" )}
┃${star}│ _🐥🄼🄾🄳🄴🐥_ : ${MODE}
┃${star}│ _🐥🅂🄴🅁🅅🄴🅁🐥_ : ${__dirname.startsWith('/skl')?"Heroku":"Private (VPS)"}
┃${star}│ _🐥🄰🅅🄰🄸🄻🄰🄱🄻🄴 🅁🄰🄼🐥_ : ${used} of ${total}
┃${star}│ _🐥🅅🄴🅁🅂🄸🄾🄽🐥_ : ${config.VERSION}
┃${star}│
┃${star}│ 
┃${star}│  ▎▍▌▌▉▏▎▌▉▐▏▌▎
┃${star}│  ▎▍▌▌▉▏▎▌▉▐▏▌▎
